...
const ThreadWelcome: FC = () => {
  return (
    <div className="aui-thread-welcome-root mb-6 flex flex-col items-center px-4 text-center">
      <span className="mb-4 flex size-12 items-center justify-center rounded-2xl bg-orange-500/15">
        <ProxMark className="size-6 text-orange-500" />
      </span>
      <h1 className="aui-thread-welcome-message-inner fade-in slide-in-from-bottom-1 animate-in fill-mode-both text-2xl font-semibold duration-200">
        Vulcan OmniPro 220 — Product Expert
      </h1>
      <p className="text-muted-foreground fade-in slide-in-from-bottom-1 animate-in mt-2 max-w-md text-sm fill-mode-both duration-200">
        Ask me about setup, polarity, duty cycle, settings, or troubleshooting
        your welder. I can show diagrams from the manual and run the numbers
        for you.
      </p>
...
const WELCOME_SUGGESTIONS = [
  ...
  "What polarity do I need for TIG — which socket does the ground clamp go in?",
  "I'm getting porosity in my flux-cored welds",
  "Walk me through setting up MIG for thin sheet metal",
];
      ...
      {WELCOME_SUGGESTIONS.map((prompt) => (
        ...
        >
          <ThreadPrimitive.Suggestion
            ...
            method="replace"
            autoSend
            className="aui-thread-welcome-suggestion text-foreground hover:bg-muted hover:border-orange-500/40 border-border/60 h-auto cursor-pointer rounded-full border px-3.5 py-1.5 text-sm font-normal whitespace-nowrap transition-colors"
          >
            {prompt}
          </ThreadPrimitive.Suggestion>
        </div>
